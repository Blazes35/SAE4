    ...
    <div class="contenuPopup">
        ...
        <div>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) { ?>
                    <form class="formPopup" action='traitements/update_user_info.php' method="post">
                        ...
                        <div>
                            ...
                            <input class="zoneDeTextePopup zoneDeTextePopupFixSize" type="text" name="new_nom" pattern="[A-Za-z0-9îçôâêœëÿçêôïëœôêçéêàçœçêëè ]{0,100}" value="<?php echo htmlspecialchars($row["Nom_Uti"]) ?>">
                        </div>
                        <div>
                            <label for="new_prenom"><?php echo $htmlPrénomDeuxPoints ?></label>
                            <input class="zoneDeTextePopup zoneDeTextePopupFixSize" type="text" name="new_prenom" pattern="[A-Za-z0-9îçôâêœëÿçêôïëœôêçéêàçœçêëè ]{0,100}" value="<?php echo htmlspecialchars($row["Prenom_Uti"]) ?>">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input class="zoneDeTextePopup" type="text" name="rue" pattern="[A-Za-z0-9îçôâêœëÿçêôïëœôêçéêàçœçêëè ]{0,100}" title="<?php echo $htmlConditionsRue; ?>" required>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <input class="zoneDeTextePopup" type="text" name="ville" pattern="[A-Za-z0-9îçôâêœëÿçêôïëœôêçéêàçœçêëè ]{0,100}" title="<?php echo $htmlConditionsVille; ?>" required>
                        </div>
                        <div>
                ...
                <p><?php echo $htmlAucunResultatCompte ?></p>
            <?php } ?>
        </div>
    </div>
</div>